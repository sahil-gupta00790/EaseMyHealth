...
class _$AppointmentImpl implements _Appointment {
  ...
  @override
  String toString() {
    return 'Appointment(id: $id, doctorName: $doctorName, specialization: $specialization, dateTime: $dateTime, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, doctorName, specialization, dateTime, status);
